...
const FormAddAuthor = ({ action, type, submitName, setPatch }) => {
      ...
      >
        {type == "add" && (
          <>
            ...
            >
              <Input className="inp" placeholder="Input Your Value!!" />
            </Form.Item>
            <Form.Item
              name="label"
              className="item-inp"
            ...
            >
              <Input className="inp" placeholder="Input Your Labe!!" />
            </Form.Item>
            <Form.Item
              name="biografi"
              className="item-inp"
              rules={[
                {
                  required: true,
                  message: "Biografi Can't be empty",
                },
              ]}
            >
              <TextArea
                rows={5}
                className="ta-inp"
                placeholder="Input Your Biografi..."
              ></TextArea>
            </Form.Item>
          </>
        )}
        {type == "update" && (
          <>
            ...
            >
              <Input
                value="udcjdcbdbcjdbcjdbcjdbcjbd"
                className="inp"
